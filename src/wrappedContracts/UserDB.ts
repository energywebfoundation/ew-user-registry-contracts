    ...
    export class UserDB extends GeneralFunctions
{
    ...
    constructor(web3: Web3, address?: string){
        super(address ? new web3.eth.Contract(UserDBJSON.abi, address) : new web3.eth.Contract(UserDBJSON.abi, UserDBJSON.networks.length > 0 ? (UserDBJSON.networks[0]) : null))
        this.web3 = web3
    }
    ...
    async getAllEvents(eventFilter?:SearchLog){
    	...
    	async setOrganization(_user:string,_organization:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setOrganization(_user,_organization)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setOrganization(_user,_organization)
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setOrganization(_user,_organization)
	...
	async setRoles(_user:string,_roles:number, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setRoles(_user,_roles)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setRoles(_user,_roles)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setRoles(_user,_roles)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async setUser(_user:string,_organization:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setUser(_user,_organization)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setUser(_user,_organization)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setUser(_user,_organization)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async setUserActive(_user:string,_active:boolean, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setUserActive(_user,_active)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setUserActive(_user,_active)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setUserActive(_user,_active)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
